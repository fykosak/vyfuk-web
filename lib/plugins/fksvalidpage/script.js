...
var $ = jQuery;
    $("label").click(function() {
        console.log(this.id + '_page');
        $('#' + this.id + '_page').slideDown();
    });



    $('#fkssearch').submit(function(event) {
        ...
        $.post(
                ...
                {call: 'plugin_fkssearch', target: 'search', name: 'local', key: s},
        function(data) {
            console.log(data);
            $lostdiv.html('<div class="search_r">'
                    + data['links']
                    + '</div>');
