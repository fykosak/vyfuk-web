...
if(!headers_sent() && !defined('NOSESSION')) {
    if(!defined('DOKU_SESSION_NAME'))     define ('DOKU_SESSION_NAME', "DokuWiki2"); // in order to run two instances of Dokuwiki on the same domain (michal@fykos.cz, 2014-11-15)
